...
"""
Update the ECS task definition for property-api to use the new commit hash (13b9ceb).
"""
import json
...
with open('/tmp/reg_payload_v2.json', 'w') as f:
    json.dump(reg_payload, f, indent=2)
print("Written to /tmp/reg_payload_v2.json")
